...
from rest import routes, sockets
...
def create_app(configuration):
    ...
    app.register_blueprint(sockets.livemap.bp)
    # custom deploy
    app.register_blueprint(routes.cisangkan.bp)
    app.register_blueprint(routes.absence.bp)
