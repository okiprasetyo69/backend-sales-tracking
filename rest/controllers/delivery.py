            ...
            if delivery_plan["packing_slip_id"] is not None:
                ...
                for rec in delivery_plan['packing_slip_id']:
                    try:
                        ...
                        my_customer = self.customer_model.get_customer_by_code(self.cursor, code=packing['customer_code'])
                        delivery_plan['packing_slip_id'][idx]['customer_code'] = packing['customer_code']
                        delivery_plan['packing_slip_id'][idx]['customer_name'] = my_customer[0]['name']
