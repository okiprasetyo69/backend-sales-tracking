...
class CustomerController(object):
    ...
    #Start Customizing
    def get_all_customer_data_filtered( self, page: int, limit: int, search: str, column: str, direction: str, has_list: bool, list_customer: list, isFilter: bool, dataFilter: list
    ):
        customer = {}
        data = []
        where_user = ""
    ...
    def get_all_customer_data_only_assigned( self, page: int, limit: int, search: str, column: str, direction: str, list_customer: list, dropdown: bool, isFilter: bool, dataFilter: list ):
        customer = {}
        data = []
        where_user = ""
        start = page * limit - limit
    ...
    def get_all_export_customers(self, page: int, limit: int, search: str, column: str, direction: str, list_customer: list, dataFilter: list
    ):
        customer = {}
        result_data = {}
        data = []
    ...
    def get_particular_field(self, field: dict, list_customer: list):
        ...
        if field.get('field') == "parent_code":
            ...
            result = self.customer_model.get_particular_field(self.cursor, select='parent_code', where=where)
            if result:                    
                list_parent = []
                for row in result:
